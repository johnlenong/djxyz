...
if (vValue) {
	...
	$.getJSON('https://cdn.jsdelivr.net/gh/johnlenong/djxyz@main/db/post/' + vValue.split('#')[0].toUpperCase() + '.json', function(data) {
			...
			for (let i = 1; i < pictr.length; i++) {
				$('#partList').append(`<li><a href="${posts}&p=${i}"><img alt="Part-${i}" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsE${pictr[i]}/w600-h350-c-rw/thumb.webp" width="600" height="350" /><span><i class="fa-solid fa-pizza-slice"></i> Part  ${i} </span></a></li>`);
			}
